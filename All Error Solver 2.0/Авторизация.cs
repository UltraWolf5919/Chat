...
namespace All_Error_Solver
{
    public partial class Авторизация : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (textBox1.Text == "admin" || textBox2.Text == "admin") // проверка на корректный ввод данных в поля
                {
                    ...
                    using (MySqlConnection connection = new MySqlConnection(Connect))
                    {
                        ...
                        if (td.Rows.Count > 0)
                        {
                            ...
                            MessageBox.Show("Вы авторизованы как администратор.", "Сообщение"); // успешное подключение
                            win2.ShowDialog();
                        }
                        else
                        {
                            MessageBox.Show("Неправильный логин или пароль", "Ошибка"); // неудачное подключение
                        }
                    }
                }
                else
                {
                    ...
                    MessageBox.Show("Неправильный логин или пароль", "Ошибка"); // ошибка ввода данных в поля
                }
            }
        }
    }
