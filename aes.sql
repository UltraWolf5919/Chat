...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 02 2021 г., 17:17
...
(1, 'Афонасьев Максим Альбертович', 'Владелец группы компаний \"Аксус\"', 'Afonasiev_Maxim@axus.name', 89277001122, 'Самара, 443076, ул. Авроры, д.63'),
(2, 'Афонасьев Дмитрий', 'Директор компании \"Аксус-Интеграция\"', 'afonasievm@axus.name', 89277266423, 'Самара, 443076, ул. Авроры, д.63'),
...
(4, 'Ферфетский Сегрей Алексеевич', 'Ведущий системный администратор', 'FerfetskiiSA@axus.name', 89279064523, 'Самара, 443076, ул. Авроры, д.63'),
